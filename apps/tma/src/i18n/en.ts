export const en = {
  ...
  create: {
    ...
    name: 'Circle name',
    members: 'Members (N)',
    contribution: 'Contribution per round (USDC)',
  ...
  join: {
    ...
    stepWalletTitle: 'Connect your TON wallet',
    stepWalletBody: 'Joining a circle requires a TON wallet. Pick any TonConnect-compatible wallet (Tonkeeper, MyTonWallet, etc.) to continue.',
    stepWalletConnect: 'Connect wallet',
    stepVaultTitle: 'Activate your vault',
    stepVaultBody: 'For gasless transactions we deploy a personal vault contract — one-time. Your wallet will be asked to approve this activation (≈0.3 TON gas on testnet).',
    stepVaultActivate: 'Activate vault',
  ...
  kye: {
    ...
    pending: 'Pending',
    defaulted: 'Defaulted',
    contributeNow: 'Pay 100 USDC contribution',
  ...
  wallet: {
    ...
    rePair: 'Re-pair',
    ownerWallet: 'Your wallet (Tonkeeper)',
    ownerWalletNote: 'You hold this directly. Deposit moves USDC into your Vault before circle actions.',
    ...
    deposit: 'Deposit',
    depositDone: 'Deposit submitted.',
    availableInWallet: 'In your wallet',
    toMyWallet: 'To my connected wallet',
    max: 'Max',
    amountExceeds: 'Amount exceeds available balance.',
    faucetTitle: 'Testnet faucet',
    faucetBody: 'Get 1000 USDC sent to your connected wallet to try Roosta. Testnet only — no claim limit.',
    faucetUnlimitedNote: 'You can claim again as many times as you need.',
    faucetClaim: 'Claim 1000 USDC',
    faucetClaimed: 'Already claimed',
    faucetDone: 'Faucet sent. Funds will appear in your wallet shortly.',
  },
  vault: {
    ...
    vaultBalance: 'Vault balance (used for circle contribute)',
    vaultBalanceNote: 'Gasless contract balance used for joining, contributing, and receiving payouts.',
