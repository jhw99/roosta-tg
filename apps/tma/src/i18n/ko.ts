...
export const ko: Strings = {
  ...
  join: {
    ...
    stepWalletTitle: '먼저 TON 지갑을 연결해주세요',
    stepWalletBody: '계에 참여하려면 TON 지갑 연결이 필요합니다. Tonkeeper, MyTonWallet 같은 TonConnect 지원 지갑을 선택해주세요.',
    stepWalletConnect: '지갑 연결',
    stepVaultTitle: 'Vault 를 활성화해주세요',
    stepVaultBody: '가스리스 거래를 위해 1회 한정으로 vault 컨트랙트를 배포합니다. 지갑에서 활성화 트랜잭션 한 번 승인이 필요합니다 (테스트넷 0.3 TON 가스).',
    stepVaultActivate: 'Vault 활성화',
  ...
  wallet: {
    ...
    disconnect: '연결 해제',
    rePair: '재연결',
    ownerWallet: '내 지갑 (Tonkeeper)',
    ownerWalletNote: '본인이 직접 보유. 회로 참여 전 Deposit 으로 Vault 로 옮겨야 합니다.',
    ...
    deposit: '예치',
    depositDone: '예치 요청이 제출됐습니다.',
    availableInWallet: '지갑 잔액',
    toMyWallet: '연결된 지갑으로 출금',
    max: '최대',
    amountExceeds: '잔액보다 많은 금액입니다.',
    faucetTitle: '테스트넷 faucet',
    faucetBody: 'Roosta를 테스트해보세요. 연결된 지갑으로 1000 USDC를 보내드립니다. 테스트넷 전용, 횟수 제한 없음.',
    faucetUnlimitedNote: '횟수 제한 없이 다시 받을 수 있습니다.',
    faucetClaim: '1000 USDC 받기',
    faucetClaimed: '이미 받음',
    faucetDone: '전송 완료. 잠시 후 지갑에 반영됩니다.',
  },
  vault: {
    ...
    vaultBalance: 'Vault 잔액 (회로 contribute 사용)',
    vaultBalanceNote: '계 참여 / 납입 / payout 받기에 사용되는 가스리스 컨트랙트 잔액.',
